...
import { Process, IProcess, ProcessStepsTypeEnum, ProcessStatusTypeEnum, DIProcess} from '../../common'
...
export class ProcessService {
  ...
  async findAll(): Promise<DIProcess[]> {
  ...
  async findOne(id: string): Promise<DIProcess>  {
  ...
  private formatProcess(process: DIProcess) {
    ...
    console.log(daysSinceStepUpdate, process)
    return process
  }

  private getStatus(process: DIProcess, daysSinceStepUpdated: number) {
